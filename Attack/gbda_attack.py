...
def main(args):
    ...
    def gen_adv(idx):
        ...
        if args.dataset == 'mnli':
            ...
            if args.attack_target == "hypothesis":
                return adv_hypothesis, clean_hypothesis,  clean_premise, adv_label, label, error_rate
            if args.attack_targte == "premise":
                return adv_premise, clean_premise, clean_hypothesis, adv_label, label, error_rate
